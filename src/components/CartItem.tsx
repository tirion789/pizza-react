...
const CartItems: React.FC<CartItemProps> = ({id, title, type, size, price, count, imageUrl}) => {
  ...
  const onClickRemove = () => {
    ...
    return (
        ...
        <div  className="cart__item-count">
          <button  disabled = {count === 1} onClick={onClickMinus} className = {count === 1 ? "button--disabled button--circle button cart__item-count-minus" : "button button--outline button--circle cart__item-count-minus"}>
